...
5. Keep: `settings` fixture with ALL existing fields unchanged (including `azure_openai_endpoint`, `azure_openai_chat_deployment_name`, etc.). Plan 03 Task 1 will update the fixture to match the new config shape after Plan 02 changes config.py.
